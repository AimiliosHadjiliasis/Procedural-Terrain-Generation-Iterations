...
public class CustomTerrain : MonoBehaviour
{
    ...
    //Method that generates the height map based on Perlin  (base)
    public void BasePerlin()
    {
        //2D array of floats that hold the height map
        //and initialises the height map equal to the values that we have 
        //currently on our terrain
    ...
    //Method that generates the height map based on Perlin Noise (Add)
    ...
    //Method that generates height map based Simple Perlin Noise and the use of fbm (Base)
    public void BasefBMPerlin()
    {
        //2D array of floats that hold the height map
        //and initialises the height map equal to the values that we have 
        //currently on our terrain
    ...
    //Method that generates height map based Simple Perlin Noise and the use of fbm (Add)
    public void AddfBMPerlin()
    {
        //2D array of floats that hold the height map
        //and initialises the height map equal to the values that we have 
        //currently on our terrain

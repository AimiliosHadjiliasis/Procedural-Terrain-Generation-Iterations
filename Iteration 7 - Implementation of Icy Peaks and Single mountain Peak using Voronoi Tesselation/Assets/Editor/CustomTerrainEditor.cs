...
public class CustomTerrainEditor : Editor
{
    ...
    bool showVoronoiMountainPeak = false;
    ...
    public override void OnInspectorGUI()
    {
        ...
        /*********************************************************************/
        //  Load Heigths with the use of voronoi tessalation (Mountain Peaks)
        /*********************************************************************/
        showVoronoiMountainPeak = EditorGUILayout.Foldout(showVoronoiMountainPeak, "Voronoi Mountain Peak");
        if (showVoronoiMountainPeak)
        {
            if (GUILayout.Button("Generate Mountain Peaks (Voronoi)"))
            {
